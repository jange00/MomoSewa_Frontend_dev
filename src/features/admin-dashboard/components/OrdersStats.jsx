...
const OrdersStats = ({ stats }) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-4">
      ...
      <Card className="p-4 text-center bg-gradient-to-br from-blue-50 to-transparent border-blue-200">
      ...
      <Card className="p-4 text-center bg-gradient-to-br from-purple-50 to-transparent border-purple-200">
