...
const OrderSummary = ({ items, subtotal, discount = 0, deliveryFee = 0, amountNeededForFreeDelivery = 0 }) => {
    ...
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-charcoal-grey/10 p-6 space-y-6">
      ...
      <div className="pt-4 border-t border-charcoal-grey/10 space-y-3">
        ...
        {!isFreeDelivery && amountNeededForFreeDelivery > 0 && (
          <div className="bg-golden-amber/10 border border-golden-amber/20 rounded-xl p-3">
